...
// 한개의 TABLE에 대하여 다양한 View를 사용할때 여러개의 VO나 DTO를 만들면서 이름을 짓는 것이 번거로워서 구분을 한다.

// MyFoodVO : Insert, update 용
// MyFoodDTO : Select 용

// DTO(Data Transfer Object)
// DB로 부터 Select 데이터를 출력하는 곳으로 옮길때 사용할 객체
@Getter
@Setter
@ToString
@NoArgsConstructor
...
public class MyFoodCDTO {
		...
		private Float mf_qty;  // = "섭취량";
		private Float mf_once;  // = "제공량";
		private Float mf_gram;  // = "총내용량";
		private Float mf_kcal;  // = "에너지";
		private Float mf_prot;  // = "단백질";
		private Float mf_fat;  // = "지방";
		private Float mf_carbo;  // = "탄수화물";
		private Float mf_sacc;  // = "총당류";
