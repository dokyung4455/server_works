...
<%-- 외부 css file 가져오기
 ...
 그런데 지금 프로젝트에서 슬래시(/)로 접근하는 모든 요청은 homeController가 catcher 하도록 만들어져 있기 때문에 어떠한 파일로 연결을 할 수 없다. --%>

<%-- chrome browser의 캐쉬 때문에 css, js등 외부 파일을 변경해도 적용이 안되는 경우가 있다.
 ?ver=숫자 값을 변경하면 chrome browser가 파일이 변경된것으로 인식하여 새로고침을  --%>
