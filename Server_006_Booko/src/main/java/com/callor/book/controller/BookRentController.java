...
//				app.setAttribute("BUYERS", buList);
			...
			// BUYER에 담긴 회원정보를 page2.jsp에 Rendering 해서 보여라
			RequestDispatcher disp 
			...
			if(bk_title == null || bk_title.equals("")) {
				...
				List<BookDTO> bookList = bkServiece.findByTitle(bk_title);
